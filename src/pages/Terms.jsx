...
import { FaFileContract, FaBookOpen, FaShieldAlt, FaGavel } from 'react-icons/fa'
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl shadow-sm p-6 md:p-10">
              ...
              <section id="interpretation" className="mb-12">
                ...
                <div className="space-y-4 bg-gray-50 rounded-lg p-6">
                  {[
                    ...
                    { term: 'Company', definition: '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FastPay LLC, Silver Spring, Maryland 20902.' },
                    { term: 'Content', definition: 'refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.' },
                    ...
                    { term: 'Website', definition: 'refers to FastPay, accessible from https://www.fastpayet.com/' },
              ...
              <section id="content" className="mb-12">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Your Right to Post Content</h3>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Content Restrictions</h3>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-6">Content Backups</h3>
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
              ...
              <section id="copyright" className="mb-12">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Intellectual Property Infringement</h3>
                <div className="space-y-4 text-gray-700 leading-relaxed mb-6">
                  <p>
                    We respect the intellectual property rights of others. It is Our policy to respond to any claim that Content posted on the Service infringes a copyright or other intellectual property infringement of any person.
                  </p>
                  <p>
                    If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at <a href="mailto:info@fastpayet.com" className="text-primary-600 hover:text-primary-700 font-semibold">info@fastpayet.com</a> and include in Your notice a detailed description of the alleged infringement.
                  </p>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-gray-50 rounded-lg p-6 space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-start">
                      <span className="text-primary-600 font-bold mr-2 flex-shrink-0">{index + 1}.</span>
                      <span className="text-gray-700">{item}</span>
                    </div>
                  ))}
                </div>
                ...
                <p className="text-gray-700 leading-relaxed mt-4">
                  You can contact our copyright agent via email at <a href="mailto:info@fastpayet.com" className="text-primary-600 hover:text-primary-700 font-semibold">info@fastpayet.com</a>. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.
                </p>
              </section>
              ...
              <section id="disputes" className="mb-12">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">For European Union (EU) Users</h3>
                  <p>
                    If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.
                  </p>

                  <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">United States Legal Compliance</h3>
                  <p>
              ...
              <section id="severability" className="mb-12">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Severability</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
                </p>

                <h3 className="text-2xl font-bold text-gray-900 mb-4">Waiver</h3>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.
                </p>

                <h3 className="text-2xl font-bold text-gray-900 mb-4">Translation Interpretation</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="contact" className="mb-8">
                ...
                <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-xl p-6 space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <FaGavel className="text-primary-600 text-xl" />
                    <div>
                      <p className="font-semibold text-gray-900">By visiting our contact page:</p>
                      <Link to="/contact" className="text-primary-600 hover:text-primary-700 font-semibold">
                        https://www.fastpayet.com/contact-us
                      </Link>
                    </div>
                  </div>
                </div>
